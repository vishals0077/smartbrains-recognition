...
class SignIn extends React.Component
{
  ...
  onButtonClick=()=>
  { 
    fetch("https://immense-hamlet-47321.herokuapp.com/api/signin",{
      method: 'post',
    ...
    }).then(response=> response.json()).then(data=>
    {
      ...
      {
        alert("Your credentials are invalid. Please sign up to continue")
      }
  ...
  <form className="measure center">
    ...
    <div className="mt3">
            ...
            <p className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" onClick={this.onButtonClick }>Sign In </p>
    </div>
    <div className="lh-copy mt3">
       <p className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" onClick={this.props.signupclick}>Sign up</p>    
